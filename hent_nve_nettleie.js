 ...
 *
 * * TEKNISKE TILPASNINGER v11.8:
 * 1. DATO-ROBUSTHET: Skriptet finner automatisk neste mandag dersom det kjøres
 * i en helg for å sikre representativ hverdags-tariff.
 * 2. AUTOMATISK MAPPING: Oversetter NVEs data til de faste variablene som 
 * brukes i Bjørnar Almlis "Strømregning"-app.
 * 3. KRONE-RETTELSE: Deler energileddet på 100 for å lagre verdien i kroner. 
 * Kritisk for Homey 2023 som ellers ignorerer verdier over 5 kr/kWh.
 * 4. TYPE-SIKRING: Tvinger lagring som 'Number' for å unngå tekst-bug i Homey.
 * 5. DYNAMISK INPUT: Nettselskap kan settes manuelt i variabelen over, eller 
 * hentes automatisk fra Flow som et argument (args[0]).
 * ============================================================================
 */

async function oppdaterNettleieNVE() {
    // Sjekker om Flow sender med et argument (args[0]), hvis ikke brukes NETTSELSKAP-variabelen
...
const db = {
   ...
   "vissi_finnmark": { "org": "921683057", "fylke": "56" }
    ...
    try {
        ...
        // API-URL med dynamiske variabler fra konfigurasjon
        ...
        log(`📅 Henter hverdagspris (Dato: ${datoStreng})`);
        ...
        // Energiledd deles på 100 for å få kroner (Optimalisert for Strømregning-app & Homey Pro 2023)
        ...
        log(`------------------------------------------------------------`);
        log(`📝 SKRIVER TIL HOMEY TAGS (TALLVERDIER I KR):`);
        ...
        log(`------------------------------------------------------------`);
        log(`✅ Oppdatering fullført! (v11.8)`);
        return true;
